...
\sbox{\objbox}{
	\begin{minipage}[b]{0.65\textwidth}
		To build a world with greater equality, freedom, and privacy for all, leveraging my \mbox{experience engineering} secure software systems. Recently, I have
		\begin{itemize}
			...
			\item Managed external pentests and regular security audits as the sole Security Architect at a company with multiple international enterprise clients, satisfying meticulous customer security team stakeholders, enabling customer growth and expansion.
		\end{itemize}
	\end{minipage}
}
\usebox{\objbox}\hfill
...
\begin{itemize}
	...
	\item Golang,  Python,  Ruby, or Java to impement software features, utilizing Postgres and NoSQL databases for storage.
